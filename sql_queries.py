...
""")
top_ten_artists =("""
     SELECT a.name as top_artists, COUNT(sp.songplay_id) AS no_play_times
    FROM "songplays" AS sp
    JOIN "artists" As a on sp.artist_id = a.artist_id
    GROUP BY a.name
    ORDER BY no_play_times DESC
    LIMIT 10;
""")
...
analytic_queries =[top_ten_songs,top_ten_artists]
